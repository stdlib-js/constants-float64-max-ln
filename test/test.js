...
tape( 'export is a double-precision floating-point number equal to the natural logarithm of the max double-precision floating-point number', function test( t ) {
	t.strictEqual( FLOAT64_MAX_LN, ln( pow(2, 1023) * (2-pow(2, -52)) ), 'equals the logarithm of the max value (computed)' );
	t.strictEqual( FLOAT64_MAX_LN, ln( FLOAT64_MAX ), 'equals the logarithm of the max value' );
	t.end();
});
